    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        <div className={styles.footerInfo}>
          <p className={styles.copyright}>&copy; {currentYear} Arnav Gupta &nbsp;·&nbsp; Independent Researcher</p>
        ...
        <div className={styles.socialLinks}>
          ...
          <a href="https://www.linkedin.com/in/arnav-gupta-090a87323/" target="_blank" rel="noreferrer" className={styles.socialLink}>LinkedIn</a>
